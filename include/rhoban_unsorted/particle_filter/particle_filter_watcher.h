...
public:
  ...
  public:
    ...
    Entry(const Utils::Timing::TimeStamp& ts_, double consistency_) : ts(ts_), consistency(consistency_)
    {
    }
  ...
  void pushObservations(const Utils::Timing::TimeStamp& ts, const ObservationSet& observations,
